...
algMenu = ttk.Combobox(UI_frame, textvariable = selected_alg, values= ['Bubble Sort', 'Quick Sort','Merge Sort'], width = 15)
algMenu.grid(row = 0, column = 1, padx = 0, pady = 5)
algMenu.current(0)

speedScale = Scale(UI_frame, from_ = 0.1, to = 2.0, length = 100, digits = 2, resolution = 0.2, orient = HORIZONTAL, label = "Select Delay(s)")
speedScale.grid(row = 0, column = 2, padx = 5, pady = 5)
Button(UI_frame,text="Start", command = startAlgorithm, bg = "Red", width = 10).grid(row = 0, column = 3, padx = 5, pady = 5, columnspan = 2, sticky = N)
...
Button(UI_frame,text="Next Step", command = printNextStep, bg = "green", width = 10, height = 2).grid(row = 1, column =4, padx = 2, pady = 2)
root.mainloop()
